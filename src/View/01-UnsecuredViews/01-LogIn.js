    ...
    <View style={tw`items-center flex-1 bg-pureblack-0`}>
      ...
      <View style={tw`w-352`}>
        ...
        <View style={tw`w-full`}>
          ...
          <TextInput style={tw`mt-8 h-48 bg-pureblack-5 rounded-3 border border-pureblack-10 text-14 px-12 text-black-800 outline-none`} />
        </View>
        <View style={tw`w-full my-24`}>
          <View style={tw`flex-row justify-between`}>
            <Text style={tw`text-12 text-black-700`}>Password</Text>
            <Text
              style={tw`text-12 text-highlight-800`}
              href='#'
              onPress={() => {
          ...
          <TextInput style={tw`mt-8 h-48 bg-pureblack-5 rounded-3 border border-pureblack-10 text-14 px-12 text-black-800`} />
        </View>
